...
The model collection is automatically generated using a list of feature expansions with xgboost variable filtering applied. Each resulting feature-set is fed into a user defined list of model types
